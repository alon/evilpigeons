...
======================
Windows: after installing, run the evilpigeons.exe in the installation directory.
Ubuntu/Linux, Mac: no installer, run from source

Running From source:
===================
Linux and Mac: ./run.sh
Windows: run (a batch file, run.bat)
